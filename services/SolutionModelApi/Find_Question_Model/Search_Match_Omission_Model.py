...
rule = ['개인정보의 처리 목적', '개인정보의 처리 및 보유 기간', '처리하는 개인정보의 항목',
        ...
        '행태정보의 수집·이용·제공 및 거부 등에 관한 사항','추가적인 이용·제공 관련 판단 기준','가명정보 처리에 관한 사항','개인정보 보호책임자에 관한 사항(개인정보에 관한 민원서비스)','국내대리인 지정에 관한 사항','개인정보의 열람청구를 접수·처리하는 부서','정보주체의 권익침해에 대한 구제방법',
