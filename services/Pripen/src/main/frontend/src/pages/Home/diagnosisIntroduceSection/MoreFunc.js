...
const MoreFunc = () => {
    const boxes = [
        ...
        { title: '위반 유형별 결과 제공', description: '호스피는 법률 위반 뿐만 아니라, 처리방침 작성지침과 법률 위반에 애매모호한 부분까지 알려드려요.', icon: <CreditScoreIcon   sx={{width:'50px', height:'50px', marginBottom:'10px', color: '#009bff'}} /> },
        ...
        { title: '모범 사례 제공', description: '어떻게 고쳐야 할지 감이 안오나요? 여러분의 위반 유형에 대한 모범 사례를 통해 감을 익혀보세요.', icon: <StarIcon sx={{width:'50px', height:'50px', marginBottom:'10px', color: '#009bff'}} /> },
