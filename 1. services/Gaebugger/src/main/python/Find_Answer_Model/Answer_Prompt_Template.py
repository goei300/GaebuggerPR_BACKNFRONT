...
위반 유형은 [법률 위반, 법률 위반 위험, 지침 미준수] 딱 3가지가 있어. 이것 이외에는 없어!
...
위반 사항: (있음 or 없음)
위반 유형: (법률 위반 or 법률 위반 위험 or 지침 미준수 or 없음)
위반 문장: (위반문장 or 없음)
...
<주의사항>
[예시3]처럼 따옴표(")같은 문장부호를 너가 문장의 앞과 뒤에 절대로 임의로 붙이지마! <개인정보처리방침>에서 그대로 가지고 와줘!
[예시3]
